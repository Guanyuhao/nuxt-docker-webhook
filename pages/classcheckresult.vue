                ...
                <div class="white-space">
                    ...
                    <div class="table">
                        <div class="tableHeader">
                            ...
                            <div class="tagResult color">标注结果</div>
                            <div class="tagTime color">标注时间</div>
                        </div>
                        <div class="tableBody" v-for="(item,index) in list" :key="index" @click="back(item.dataId)">
                            <div class="number color">{{item.showId}}</div>
                            <div class="descript color" :title="item.content">{{item.content}}</div>
                            <div class="tagResult color">{{item.cateName}}</div>
...
export default {
    ...
    async back(id){
      ...
      if(this.$route.query.status==-2){
            this.$router.push({path:`/classexamp?page=${data}&proId=`+this.$route.query.proId+"&id="+id})
      }else if(this.$route.query.status==-1){
            this.$router.push({path:`/classcheck?page=${data}&proId=`+this.$route.query.proId+"&id="+id})
      }else if(this.$route.query.status==0){
            this.$router.push({path:`/classformal?page=${data}&proId=`+this.$route.query.proId+"&id="+id})
      }else{
          this.$router.push({path:`/classcommit?page=${data}&proId=`+this.$route.query.proId+"&id="+id})
      }
    },    
