<template>
  <div class='container'>
    ...
    >
      ...
      <aside-infor @taskStand='taskStand' @taskDetail='taskDetail' :link='standLink'></aside-infor>
...
export default {
  ...
  data() {
    return {
      ...
      colorArr: [
        ...
        { color: "#525DD7", background: "#EAEBFF" },
        { color: "#97183E", background: "#FAE7E7" },
        { color: "#A95508", background: "#FFEDC3" }, { color: "#525DD7", background: "#EAEBFF" },
        { color: "#97183E", background: "#FAE7E7" },
        { color: "#A95508", background: "#FFEDC3" },
        { color: "#22894B", background: "#DFEEE7" },
        { color: "#086B91", background: "#DBEFF7" },
  ...
  methods: {
    ...
    nextPage() {
      ...
      this.$router.push({path:`/classexamp?page=${this.curPagerNo}&proId=`+this.$route.query.proId})
      this.initBottom();
    },
    prePage() {
      this.$refs.morelist.hide();
    ...
    goDetail(){
        this.$router.push({path:'classcheckresult',query:{status:-2,proId:this.$route.query.proId}})
    },
    showClick() {
      if (!this.show) {
