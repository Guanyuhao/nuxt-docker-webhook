    ...
    <div class="create-user-wrap" v-show="state">
        <div class="create-user">
            ...
            <div class="depart clearfix">
                ...
                <div class="input"><el-input v-model="depart" placeholder=""></el-input></div>
                <div class="icon"></div>
            </div>
...
export default {
    ...
    methods:{
        show(obj){
            this.state = true;
            this.role = obj.roleName;
            this.depart = obj.reserve2;
            this.radio  = obj.status+"";
